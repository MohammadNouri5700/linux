...
void apkey_to_hwkey(unsigned char *apkey)
{
    int index=0;
...
static ssize_t atsha204a_read (struct file *filp, char __user *buff, 
        size_t count, loff_t *offp)
{
    ...
    switch(atsha204a_info.read_mode)
    {
        ...
        case read_password_mode:
            ...
            if( copy_to_user(buff+1, read_buf+1, strlen(read_buf)-1)){
